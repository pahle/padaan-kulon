            ...
            <div className="mt-4 flex flex-col font-display text-lg tracking-tight text-blue-900 sm:text-2xl">
              <div>
                <p className="max-w-[] text-justify font-display sm:text-left">
                  ...
                  <br />
                  Sebagai Kepala Dukuh Padaan Kulon, saya berharap seluruh warga
                  senantiasa rukun, gotong royong, dan bersama-sama membangun
                  lingkungan yang aman dan sejahtera.
