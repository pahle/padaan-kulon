        ...
        <Container className="relative">
          <div className="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
            <h1 className="font-display text-5xl font-bold tracking-tighter text-green-600 sm:text-7xl ">
              ...
              AB.83.181 UPNVYK Padukuhan Padaan Kulon
            </h1>
            <div className="mt-6 space-y-6 text-justify font-display text-lg tracking-tight text-green-900 sm:text-left sm:text-2xl ">
              <p>
                Cerita kami, KKN AB.83.181 dari UPN &quot;Veteran&quot;
                Selama satu bulan kami melaksanakan KKN di Padukuhan Padaan Kulon,
                kami mendapatkan pengalaman yang menyenangkan dan penuh makna. Sambutan
                hangat serta keramahan warga memberikan kesan yang mendalam bagi kami. 
                Banyak pelajaran berharga yaang kami peroleh, berbagai cerita yang kami
                bagi, serta momen-momen sederhana yang membuat suasana KKN ini menjadi
                berkesan. Kami berharap kehadiran kami membawa manfaat untuk Padukuhan Padaan Kulon
              </p>
            </div>
            <Button
        ...
        <Container className="relative z-10">
          <div className=" lg:mx-0 lg:w-full lg:pr-0">
            ...
            <div className="mt-4 flex flex-col font-display text-lg tracking-tight text-green-900 sm:text-2xl">
              ...
              <div className="mt-4">
                <p className="font-bold">Boy Jepo Martcele Ginting</p>
                <p>Ketua Kelompok KKN AB.83.181</p>
              </div>
            </div>
          </div>
        </Container>
