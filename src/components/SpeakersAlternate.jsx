...
import suciImage from '@/images/anggota/suci.JPG'
import estiImage from '@/images/anggota/esti.JPG'
import uusImage from '@/images/anggota/uus.JPG'
import bimaImage from '@/images/anggota/bima.JPG'
import boyImage from '@/images/anggota/boy.jpeg'
import renitaImage from '@/images/anggota/renita.JPG'
import hasnaImage from '@/images/anggota/hasna.JPG'
import bungaImage from '@/images/anggota/bunga.JPG'
import aninImage from '@/images/anggota/anin.JPG'
import virgiImage from '@/images/anggota/virgi.JPG'
import kadekImage from '@/images/anggota/kadek.JPG'

const days = {
  speakers: [
    {
      name: 'Boy Jepo Martcele Ginting',
      role: 'Ketua',
      major: 'Hubungan Internasional',
      image: boyImage,
    },
    {
      name: 'Hasna Shofi Afifah',
      role: 'Sekretaris',
      major: 'Sistem Informasi',
      image: hasnaImage,
    },
    {
      name: 'Renita Anggraini',
      role: 'Bendahara',
      major: 'Ekonomi Pembangunan',
      image: renitaImage,
    },
    {
      name: 'Ni Kadek Berlianti',
      role: 'PDD',
      major: 'Manajemen',
      image: kadekImage,
    },
    {
      name: 'Nazhara Anindya',
      role: 'PDD',
      major: 'Teknik Lingkungan',
      image: aninImage,
    },
    {
      name: 'Virginia Yuli Pratama',
      role: 'Perkap',
      major: 'Akuntansi',
      image: virgiImage,
    },
    ...
    {
      name: 'Ahmad Bimanda Rifqi Fahrizal',
      role: 'Humas',
      major: 'Teknik Pertambangan',
      image: bimaImage,
    },
    {
      name: 'Suci Sekar Sari',
      role: 'Humas',
